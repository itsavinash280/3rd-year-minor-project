...
export class DiseaseDetectionEngine {
  private static diseaseDatabase: Record<string, DiseaseDetectionResult> = {
    tomato_early_blight: {
      ...
      disclaimer:
        'AI Diagnosis Notice: This prediction is generated by automated vision models. Always inspect field conditions and consult your local Krishi Vigyan Kendra (KVK) expert before major pesticide application.',
    ...
    paddy_bacterial_blight: {
      ...
      disclaimer:
        'Bacterial Leaf Blight can spread rapidly. Immediate field inspection is advised.',
      expertEscalationRecommended: false,
    },
    wheat_yellow_rust: {
      cropName: 'Wheat',
